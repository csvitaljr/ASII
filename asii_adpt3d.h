...
#ifndef asii_adpt3d_h
#define asii_adpt3d_h

// NFAT is the number of the mini-cub that will be generate
// GRIDRECT3D contains the cub-coordinates

 void ADPT_GRIDRECT3D( int AXIS, int NFAT[4], double GRIDRECT3D[20], double **MINIRECTSIZE, int NT_MINICUB,
                     double ***VECINT3D, double **FAT_EAXIL, double **MINICUBSIZE, double **ADPCUBSIZE, double *VECINT,
                     int NIT_INTGR, double dbreak){
	...
	//Defining adaptation factor that will be aplied how a expoent of the adaptation function
	expt=-2.0;
